            ...
            <div class="col-lg-7 container">
                ...
                <div class="nav row  sb-nav" style="border: 0">
                    <ul class="nav nav-tabs nav-ul" style="border: 0">
                       <li class="nav-item">
                            <a class="nav-link" href="/" id="home_bar">HOME</a>
                        </li>
                        <div class="sb-line"></div>
                        <li class="nav-item">
                            <a class="nav-link" href="/recipeList" value="칵테일 게시판">COCKTAIL</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/party_paging" value="파티 게시판">PARTY</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/foodList" value="안주 게시판">DRINK WITH</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/noticelist" value="뉴스">NEWS</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <nav class="navbar bababa">
                        <div class="container-fluid bababa">
                          <form class="d-flex" role="search" action="/search" method="get">
                            <input class="form-control me-2 bg-transparent search_back" type="search" placeholder="search" aria-label="Search" name="keyword" required="required">
