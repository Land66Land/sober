               ...
               <div class="row profile-detail justify-content-md-center">
             	...
             	<div class="vline"></div>
               	<c:forEach var="showYN" items="${profileMaker.showYN}" varStatus="status">
               		<c:if test="${showYN}">
               			<div class="col-lg-2">
                       <div class="profile-column" style="font-family: Noto Sans KR; font-size: 12pt">${column[status.index]}</div>
                       <div class="profile-data" style="font-family: Noto Sans KR; font-size: 12pt">${data[status.index]}</div>
                 		</div>
                 		<div class="vline"></div>
               		</c:if>
               	</c:forEach>
