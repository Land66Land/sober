			...
			<div class="col-lg-7 container-fluid">
				...
				<c:if test="${empty re.ask_re_content }">
					<div class="master_reply_box">
						...
						<br>
						<button id="commentinsert" class="btn btn-outline-dark">등록</button>
						<button  class="btn btn-outline-dark" type="button" onClick="location.href='asklist?pageNum=${pageNum}'" style="margin-right:10px;">목록</button>
					</div>
				</c:if>
				<c:if test="${not empty re.ask_re_content }">
					<div class="master_reply_box">
						...
						<button type="button" class="btn btn-outline-dark" onClick="location.href='asklist?pageNum=${pageNum}'">목록</button>
					</div>
